    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CopyrightHolders", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "BookCopyrightHolder",
                columns: table => new
                {
                    BooksId = table.Column<string>(type: "text", nullable: false),
                    CopyrightHoldersId = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookCopyrightHolder", x => new { x.BooksId, x.CopyrightHoldersId });
                    table.ForeignKey(
                        name: "FK_BookCopyrightHolder_Books_BooksId",
                        column: x => x.BooksId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookCopyrightHolder_CopyrightHolders_CopyrightHoldersId",
                        column: x => x.CopyrightHoldersId,
                        principalTable: "CopyrightHolders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    BooksId = table.Column<string>(type: "text", nullable: false),
                    TranslatorsId = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReadingStatusId = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReaderDiaries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReaderDiaries_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ReaderDiaries_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ReaderDiaries_ReadingStatuses_ReadingStatusId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookCopyrightHolder_CopyrightHoldersId",
                table: "BookCopyrightHolder",
                column: "CopyrightHoldersId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReaderDiaries_BookId",
                table: "ReaderDiaries",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_ReaderDiaries_ReadingStatusId",
                table: "ReaderDiaries",
                column: "ReadingStatusId");

            migrationBuilder.CreateIndex(
                name: "IX_ReaderDiaries_UserId",
                table: "ReaderDiaries",
                column: "UserId");
